      ...
      <div className="flex flex-col justify-between h-screen">
        ...
        <div className="px-2 pt-4 h-full w-screen bg-[rgb(221,220,220)] bg-cover">
          <div className="grid grid-cols-2 gap-x-28 mx-10 p-2 px-10 mt-32">
            <div
              className="flex justify-start items-end bg-[url('/img/data_main2.jpg')] bg-cover bg-center h-[400px] w-full rounded-2xl border-2 border-gray-600 p-2 hover:border-5 hover:border-[#1e722f] shadow-md hover:shadow-2xl cursor-pointer"
              onClick={() => {
                router.push("/dashboard");
              }}
            >
              <h1 className="text-6xl text-[#1e722f] h-full flex items-end uppercase ml-2">
                Dados
              </h1>
            </div>
            <div
