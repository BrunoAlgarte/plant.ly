              ...
              <div className="col-span-2 flex justify-between items-center px-2">
                <div className="flex items-center gap-x-2">
                  <div>
                    ...
                    <h1 className="text-base text-[#1e722f]">{plant?.type}</h1>
                    <div className="flex gap-x-1 text-sm text-[#1e722f]">
                      <p>Adicionado em: </p>
                      <p>{new Date(plant.date_created).toLocaleDateString()}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-span-3 p-2">
                <div className="flex items-center gap-x-2 rounded-full px-2 shadow-lg border-2 border-[#1e722f]">
                  <div className="flex items-center gap-x-2 py-2">
                    ...
                    />
                    <p className="text-2xl font-bold text-[#1e722f]">Tipo:</p>
                  </div>
                  <div>{types?.name}</div>
                </div>
                ...
                <div className="flex items-center gap-x-2 rounded-full px-2 shadow-lg border-2 border-[#1e722f] mt-2">
                  <div className="flex items-center gap-x-2 py-2">
                    ...
                    />
                    <p className="text-2xl font-bold text-[#1e722f]">Nome científico:</p>
                  </div>
                ...
                <div className="flex items-center gap-x-2 rounded-full px-2 shadow-lg border-2 border-[#1e722f] mt-2">
                  <div className="flex items-center gap-x-2 py-2">
                    <Image
                      ...
                      className="shadow-lg rounded-full border-2 border-[#1e722f] p-0.5"
                    />
                    <p className="text-2xl font-bold text-[#1e722f]">Rega:</p>
                  </div>
                  <div className="text-sm w-3/4">{types?.watering_tips}</div>
                </div>
                ...
                <div className="flex items-center gap-x-2 rounded-full px-2 shadow-lg border-2 border-[#1e722f] mt-2">
                  <div className="flex items-center gap-x-2 py-2">
                    ...
                    />
                    <p className="text-2xl font-bold text-[#1e722f]">Sol:</p>
                  </div>
                ...
                <div className="flex items-center gap-x-2 rounded-full px-2 shadow-lg border-2 border-[#1e722f] mt-2">
                  <div className="flex items-center gap-x-2 py-2">
                    <Image
                      ...
                      className="shadow-lg rounded-full border-2 border-[#1e722f] p-0.5"
                    />
                    <p className="text-2xl font-bold text-[#1e722f]">Solo:</p>
                  </div>
                ...
                <div className="flex items-center gap-x-2 rounded-full px-2 shadow-lg border-2 border-[#1e722f] mt-2">
                  <div className="flex items-center gap-x-2 py-2">
                    <Image
                      ...
                      className="shadow-lg rounded-full border-2 border-[#1e722f] p-1"
                    />
                    <p className="text-2xl font-bold text-[#1e722f]">Crescimento:</p>
                  </div>
